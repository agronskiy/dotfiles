...
# NOTE(agronskiy): this is version working for me, it effectively reverts
# https://github.com/tmux-plugins/tmux-resurrect/pull/220/commits/8f3f8d7cb9334da85350e5fcf87c40d96532679d
#
# It fixes renaming the first window of each session.
